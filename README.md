...
<b>Row 1</b></br>
(Left image) App started. Google pops up as the default web page to load.<br>
(Middle Image) A search was initiated for the word "apple" and you can see the activity indicator animated.<br>
(Right image) Google returns the result for "apple". Dark theme is applied to pop up keyboard.<br>
</br>
<b>Row 2</b></br>
(Left image) App started. Google pops up as the default web page to load.<br>
(Middle Image) A search was initiated for the word "apple" and you can see the activity indicator animated.<br>
